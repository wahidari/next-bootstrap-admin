              ...
              <div className="container-fluid px-4">
                ...
                <div className="row">
                  <div className="col-xl-3 col-md-6">
                    <div className="card bg-blue text-white mb-4">
                  ...
                  <div className="col-xl-3 col-md-6">
                    <div className="card bg-yellow text-white mb-4">
                  ...
                  <div className="col-xl-3 col-md-6">
                    <div className="card bg-green text-white mb-4">
                  ...
                  <div className="col-xl-3 col-md-6">
                    <div className="card bg-red text-white mb-4">
